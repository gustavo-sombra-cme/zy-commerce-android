...
If any assumption here conflicts with `mvp_requirements_ecommerce.md` or `ecommerce-android-plan.md`, prefer those files and treat this document as needing revision.
